...
class ModelEvaluationTests(unittest.TestCase):
    ...
    def test_evaluate_regression_predictions_rejects_length_mismatch(self):
        with self.assertRaisesRegex(ValueError, "same length"):
            evaluate_regression_predictions("Mismatched", y_true=[100_000, 150_000], y_pred=[100_000])
    ...
    def test_compare_regression_results_rejects_empty_results(self):
        with self.assertRaisesRegex(ValueError, "At least one model result"):
